...
public class SetDishEnableAsyncTask extends AsyncTask<String, Void, JSONObject> {

    public static final String URL_SET_DISH_ENABLE = BraecoWaiterData.BRAECO_PREFIX + "/Dish/Enable";

    private OnSetDishEnableAsyncTaskListener mListener;
    private String mData;

    public SetDishEnableAsyncTask(OnSetDishEnableAsyncTaskListener mListener, String mData) {
    ...
    protected JSONObject doInBackground(String... params) {
        ...
        try {
            url = new URL(URL_SET_DISH_ENABLE);
            ...
            BraecoWaiterUtils.log("Enable " + mData);
            ...
            e.printStackTrace();
            if (byteArrayOutputStream != null) BraecoWaiterUtils.log("SetDishEnableAsyncTask: " + byteArrayOutputStream.toString());
            return null;
        }
        return null;
    }
    ...
    protected void onPostExecute(JSONObject result) {
        BraecoWaiterUtils.log("SetDishEnableAsyncTask: " + (result == null ? "Null" : result.toString()));
        if (result == null) {

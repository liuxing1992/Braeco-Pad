...
public class SetDishDisableAsyncTask extends AsyncTask<String, Void, JSONObject> {

    public static final String URL_SET_DISH_DISABLE = BraecoWaiterData.BRAECO_PREFIX + "/Dish/Disable";

    private OnSetDishDisableAsyncTaskListener mListener;
    private String mData;

    public SetDishDisableAsyncTask(OnSetDishDisableAsyncTaskListener mListener, String mData) {
    ...
    protected JSONObject doInBackground(String... params) {
        ...
        try {
            url = new URL(URL_SET_DISH_DISABLE);
            ...
            BraecoWaiterUtils.log("Disable " + mData);
            ...
            e.printStackTrace();
            if (byteArrayOutputStream != null) BraecoWaiterUtils.log("SetDishDisableAsyncTask: " + byteArrayOutputStream.toString());
            return null;
        }
        return null;
    }
    ...
    protected void onPostExecute(JSONObject result) {
        BraecoWaiterUtils.log("SetDishDisableAsyncTask: " + (result == null ? "Null" : result.toString()));
        if (result == null) {

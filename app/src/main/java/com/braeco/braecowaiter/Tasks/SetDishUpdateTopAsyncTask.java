...
public class SetDishUpdateTopAsyncTask extends AsyncTask<String, Void, JSONObject> {

    public static final String URL_SET_DISH_UPDATE_TOP = BraecoWaiterData.BRAECO_PREFIX + "/Dish/Update/Top";

    private OnSetDishUpdateTopAsyncTaskListener mListener;
    private String mData;

    public SetDishUpdateTopAsyncTask(OnSetDishUpdateTopAsyncTaskListener mListener, String mData) {
    ...
    protected JSONObject doInBackground(String... params) {
        ...
        try {
            url = new URL(URL_SET_DISH_UPDATE_TOP);
            ...
            BraecoWaiterUtils.log("Update Top " + mData);
            ...
            e.printStackTrace();
            if (byteArrayOutputStream != null) BraecoWaiterUtils.log("SetDishUpdateTopAsyncTask: " + byteArrayOutputStream.toString());
            return null;
        }
        return null;
    }
    ...
    protected void onPostExecute(JSONObject result) {
        BraecoWaiterUtils.log("SetDishUpdateTopAsyncTask: " + (result == null ? "Null" : result.toString()));
        if (result == null) {

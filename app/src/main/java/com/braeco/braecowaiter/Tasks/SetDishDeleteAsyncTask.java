...
public class SetDishDeleteAsyncTask extends AsyncTask<String, Void, JSONObject> {

    public static final String URL_SET_DISH_DELETE = BraecoWaiterData.BRAECO_PREFIX + "/Dish/Remove";

    private OnSetDishRemoveAsyncTaskListener mListener;
    private String mData;

    public SetDishDeleteAsyncTask(OnSetDishRemoveAsyncTaskListener mListener, String mData) {
    ...
    protected JSONObject doInBackground(String... params) {
        ...
        try {
            url = new URL(URL_SET_DISH_DELETE);
            ...
            BraecoWaiterUtils.log("Remove " + mData);
            ...
            e.printStackTrace();
            if (byteArrayOutputStream != null) BraecoWaiterUtils.log("SetDishRemoveAsyncTask: " + byteArrayOutputStream.toString());
            return null;
        }
        return null;
    }
    ...
    protected void onPostExecute(JSONObject result) {
        BraecoWaiterUtils.log("SetDishRemoveAsyncTask: " + (result == null ? "Null" : result.toString()));
        if (result == null) {
